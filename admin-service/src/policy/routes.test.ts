...
describe('policy routes', () => {
  ...
  it('PUT upserts the policy and audits; GET reflects it', async () => {
    ...
    const next = { personalAgentPolicy: 'company_only' as const, userModelsAllowed: false, mcpPolicy: 'allowlist', mcpAllowlist: ['wss://ok'], blockedExtensions: [], blockedIntegrations: [] }
